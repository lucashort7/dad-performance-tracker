...
M.ABILITIES = {
    ...
    ContinuousAttack = {
        ...
        shortName = "FVR",
        path = _root_hook_path .. "/ContinuousAttack/GA_BasicAttack_Continuous.GA_BasicAttack_Continuous_C:CreateHitInputs"
    },
    FollowUpAttack = {
        index = 4,
        ...
        shortName = "AA_FU",
        path = _root_hook_path .. "/BasicAttack/GA_BasicAttack_DodgeFollowup.GA_BasicAttack_DodgeFollowup_C:HandleAttackStarted"
    },
    StrongAttack = {
        index = 5,
    ...
    RangedAttack = {
        ...
        shortName = "RNG",
        path = _root_hook_path .. "/Ranged/GA_Player_DrummerangToss.GA_Player_DrummerangToss_C:ExecuteUbergraph_GA_Player_DrummerangToss"
    },
    RangedFollowUp = {
        index = 7,
        ...
        shortName = "RNG_FU",
        path = _root_hook_path .. "/BasicAttack/GA_BasicAttack_GapCloser.GA_BasicAttack_GapCloser_C:BeginAttackSequence"
    },
    DanceMove = {
        index = 8,
...
function M.GetLabel(abilityKey, layoutType)
    ...
    if not ability then return abilityKey end -- Fallback to abilityKey if not found
