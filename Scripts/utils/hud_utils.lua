...
function M.FLinearColor(R,G,B,A) return {R=R,G=G,B=B,A=A} end
function M.FSlateColor(R,G,B,A) return {SpecifiedColor=M.FLinearColor(R,G,B,A), ColorUseRule=0} end
